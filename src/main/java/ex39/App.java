...
/*
imports needed
- array & the list for the Char
- map needed for location of char?
...
public class App {
    ...
    //add names/employeeRecords in list format provided by problem
